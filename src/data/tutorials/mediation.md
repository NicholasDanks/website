...
This tutorial pairs with Video 4 in the series. Full write-up will land when the video is published. Chapter 8 of Hair et al. (2026) has the theoretical treatment, and the code file `seminr-primer-v2-chap8.R` has the runnable example.
